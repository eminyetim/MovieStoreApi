...
{
    /// <inheritdoc />
    public partial class GenresMovieCustomers : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    CustomerFavoriteGenreId = table.Column<int>(type: "int", nullable: false)
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CustomerFavoriteGenres", x => x.CustomerFavoriteGenreId);
                    table.ForeignKey(
